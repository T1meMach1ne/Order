...
menuend += "<span class=\"peisong\"><b>配送费：</b><u>9.9份</u></span>";
menuend += "<span class=\"heji\"><b>合计数量：</b><u>2份</u></span>";
...
//		var shopname = ['湘府韩城','左庭右院','沉香阁','东方快餐','麦动','铜锣湾','肯德基雁峰店','稻香人家','东来顺大酒店','尝不忘米粉'];
//		var dishname = ['清蒸大龙虾','香芋排骨','紫菜蛋汤','铁板烧牛肉','水煮牛蛙','野山椒牛肉','苦瓜酿豆腐','蒸龟塔','红烧日本豆腐','尝不忘米粉'];
//		var a = parseInt(String(Math.random()*10).substring(0,1));
//		var b = parseInt(String(Math.random()*10).substring(0,1));
...
//我的餐桌：点击小叉删除一个订单。如果要删除的订单是关闭状态，那么直接删除该订单；如果要删除的订单是展开状态，那么在删除该订单的同时展开下一个订单，当要展开的下一个订单不存在时，则展开上一个订单。
